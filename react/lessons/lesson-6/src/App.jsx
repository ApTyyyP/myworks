...
function MainContent() {
  ...
  return (
    <div className="container px-3 py-5">
      ...
      >
        {isHome && <h3>Домашнє завдання №6</h3>}
      </div>
          ...
          <table className="table table-responsive table-striped table-hover mx-auto mt-5">
            ...
            <tbody>
              <tr>
                ...
                <td>Використання <b><a href="https://react.dev/reference/react/useMemo" target="_blank">useMemo()</a></b> та <b><a href="https://react.dev/reference/react/memo" target="_blank">React.memo()</a></b></td>
              ...
              <tr>
                <th scope="row" className="number-column">2</th>
                <td>Таблиця з фільтрацією та сортуванням</td>
                <td className="action-column">
              ...
              <tr>
                <th scope="row" className="number-column">3</th>
                <td>Кастомний хук <b>useWindowSize</b> (розмір вікна браузера)</td>
                <td className="action-column">
              ...
              <tr>
                <th scope="row" className="number-column">4</th>
                <td>Кастомний хук <b>useDebounce</b> (відкладений виклик функції)</td>
                <td className="action-column">

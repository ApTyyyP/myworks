...
function MainContent() {
  ...
  return (
    <div className="container px-3 py-5">
      <div className={`mb-3 fade-${isHome ? 'exit' : 'enter'} ${!isHome ? 'fade-enter-active' : 'fade-exit-active'}`}>
        {!isHome && (
      ...
      <div
        className={`d-flex justify-content-center fade-${isHome ? 'enter' : 'exit'} ${
          isHome ? 'fade-enter-active' : 'fade-exit-active'
        }`}
      >
        {isHome && <h3>Домашнє завдання №4</h3>}
      </div>

      <div className={`fade-${isHome ? 'enter' : 'exit'} ${isHome ? 'fade-enter-active' : 'fade-exit-active'}`}>
        {isHome && (
          <table className="table table-responsive table-striped table-hover mx-auto mt-5">
            ...
            <tbody>
              <tr>
                ...
                <td>Створити імітатор мессенджера</td>
